...
const I18N = {
  ...
  'zh-TW': {
    ...
    loginToSignup: '註冊',
    heroTitle: '全球遊戲入口網站',
    heroSubtitle: '世界頂級遊戲，盡在一站',
    heroCta: '立即開始',
    contentFilterInfo: '以下內容依管理員設定的曝光國家自動篩選。切換上方國家可看到對應內容。',
    currentCountry: '目前國家',
    noticesTitle: '📢 公告',
    gamesTitle: '🎮 推薦遊戲',
    newsTitle: '📰 最新消息',
    next: '下一步', back: '上一步', confirm: '確認', skip: '跳過',
    step: '步驟',
    methodTitle: '選擇註冊方式',
    methodSub: '請選擇您偏好的方式',
    authTitle: '驗證進行中',
    authSub: '請於您選擇的服務完成驗證 (模擬)',
    authSimulating: '模擬登入中...',
    authCompleteBtn: '完成登入 (模擬)',
    termsTitle: '同意條款',
    termsSub: '請確認並同意以下條款',
    agreeAll: '全部同意',
    agreeRequired: '請同意所有必要條款',
    jurisdictionFixed: '註冊後無法變更管轄國家',
    ageTitle: '輸入出生年月日',
    ageSub: '依各國法規分流未成年',
    yearPh: '年', monthPh: '月', dayPh: '日',
    guardianTitle: '法定代理人同意',
    guardianSub: '未成年需獲得法定代理人同意',
    guardianName: '監護人姓名',
    guardianPhone: '監護人電話',
    guardianRelation: '關係',
    guardianCi: 'KMC 本人驗證 (模擬)',
    guardianUsCard: '信用卡 $0 驗證 (模擬)',
    guardianEmailVerify: '監護人信箱驗證 (模擬)',
    guardianCnId: '監護人身份證號碼 (18位)',
    realnameTitle: '實名認證',
    realnameSub: 'CN: 必要 / KR: 付款時必要',
    realnameKrBtn: 'PASS/KMC 本人驗證 (模擬)',
    cnRealname: '真實姓名 (中文)',
    cnNationalId: '身份證號碼 (18位)',
    cnFaceRecognition: '臉部辨識預留位置 (實際服務需相機權限)',
    cnAntiaddictTitle: '未成年防沉迷系統說明',
    cnAntiaddictSub: 'CN 專用 — NPPA 法規',
    cnAntiaddictHours: '<18歲: 週五·六·日及法定假日 20~21時 (每週限 3 小時)',
    cnAntiaddictSpending: '<8歲禁止儲值 / 8-16歲每月 ¥200 / 16-18歲每月 ¥400',
    cnCrossBorder: '跨境資料傳輸同意 (PIPL)',
    cnDataLocal: '中國大陸資料在地化說明',
    welcomeTitle: '註冊完成！',
    welcomeSub: '歡迎成為 MOLEP 會員',
    goHome: '返回首頁',
    summaryJurisdiction: '管轄國家',
    summaryProvider: '驗證方式',
    summaryMinor: '是否未成年',
    summaryConsents: '同意紀錄',
    yes: '是', no: '否',
    reviewTitle: '📋 考量事項',
    reviewIntro: '可在每個項目下方輸入回饋並累積儲存，隨時可編輯·刪除。',
    memoPlaceholder: '請輸入此項目的回饋/備註...',
    memoSave: '儲存', memoEdit: '編輯', memoDelete: '刪除',
    memoSaved: '已儲存', memoUpdated: '已更新',
    backToHome: '← 返回首頁'
  },
  en: {
    demo: 'DEMO',
